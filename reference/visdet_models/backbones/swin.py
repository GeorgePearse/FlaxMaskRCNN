...
class WindowMSA(BaseModule):
    ...
    Args:
        ...
        backend (str, optional): Attention backend to use. Options are
            "torch" and "flash". Default: "torch".
...
class ShiftWindowMSA(BaseModule):
    ...
    Args:
        ...
        backend (str, optional): Attention backend to use. Defaults to "torch".
...
class SwinBlock(BaseModule):
    ...
    Args:
        ...
        attn_backend (str, optional): Attention backend to use. Default: "torch".
